...
store['active_learning_steps'][0]['acquisition']={'indices': [['id', 6027], ['id', 5596], ['id', 16033], ['id', 22041], ['ood', 7372]], 'labels': [5, 7, 2, 9, -1], 'scores': [0.9443897225288551, 1.6226526906366434, 2.1002019523688, 2.4549532190470265, 2.700993118999005]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][1]['acquisition']={'indices': [['id', 37946], ['id', 30738], ['ood', 20270], ['id', 48324], ['ood', 13653]], 'labels': [0, 8, -1, 3, -1], 'scores': [0.7552434759738353, 1.4095956407654153, 1.8533561318943113, 2.152609516921851, 2.3371417770142617]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][10]['acquisition']={'indices': [['id', 51722], ['id', 20113], ['id', 29530], ['id', 50202], ['ood', 44443]], 'labels': [4, 6, 4, 5, -1], 'scores': [0.6802668992433518, 1.2831582700117234, 1.7757582880459304, 2.1332678043490496, 2.3692263616477955]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][14]['acquisition']={'indices': [['id', 10744], ['id', 36529], ['id', 8680], ['ood', 36128], ['ood', 27449]], 'labels': [7, 8, 8, -1, -1], 'scores': [0.6497267933223063, 1.2354886977002169, 1.6963562855403698, 1.9838421228878236, 2.1525814526785716]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][15]['acquisition']={'indices': [['id', 30996], ['id', 54004], ['id', 56457], ['id', 46045], ['ood', 36329]], 'labels': [1, 0, 3, 6, -1], 'scores': [0.6446182422418736, 1.1531300858011861, 1.5794925057129081, 1.8970716869585083, 2.077889768498979]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][23]['acquisition']={'indices': [['id', 20869], ['id', 26034], ['id', 33046], ['ood', 35802], ['id', 28412]], 'labels': [3, 5, 5, -1, 0], 'scores': [0.7029653933576602, 1.2830210367118529, 1.7172022740429442, 2.0536986656200558, 2.2878395319631277]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][24]['acquisition']={'indices': [['id', 5474], ['ood', 2369], ['id', 50576], ['id', 39877], ['id', 45622]], 'labels': [8, -1, 2, 7, 6], 'scores': [0.6890815737621498, 1.259501799131785, 1.6823943721791137, 1.959170169978524, 2.1217325394967137]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][25]['acquisition']={'indices': [['id', 52981], ['id', 10736], ['ood', 39314], ['id', 16286], ['id', 13460]], 'labels': [5, 4, -1, 0, 5], 'scores': [0.7060827795360818, 1.3280556302621278, 1.8344929528321714, 2.249229088604431, 2.4909280857655887]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][26]['acquisition']={'indices': [['id', 49582], ['id', 31014], ['id', 17222], ['ood', 28218], ['id', 42417]], 'labels': [2, 8, 8, -1, 8], 'scores': [0.6099518973470772, 1.1512931225275187, 1.6004848310579805, 1.9387800429831312, 2.166575171461133]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][27]['acquisition']={'indices': [['id', 14423], ['ood', 53215], ['id', 47870], ['ood', 48253], ['ood', 52513]], 'labels': [6, -1, 9, -1, -1], 'scores': [0.7347568993491096, 1.3404409236088295, 1.8494955744035027, 2.1891890723474097, 2.394942252881469]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][28]['acquisition']={'indices': [['id', 43126], ['id', 57882], ['id', 12000], ['id', 16590], ['ood', 59234]], 'labels': [3, 0, 7, 6, -1], 'scores': [0.6466350219529791, 1.2499569476245016, 1.7503374365615807, 2.102220500699028, 2.331656562006085]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][29]['acquisition']={'indices': [['id', 20169], ['id', 12514], ['id', 27838], ['ood', 25905], ['id', 41618]], 'labels': [4, 2, 3, -1, 5], 'scores': [0.6578212545776772, 1.2439978719091456, 1.6859703518037499, 2.0043396033121104, 2.21988579991206]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][31]['acquisition']={'indices': [['id', 15767], ['id', 8765], ['id', 25661], ['ood', 28766], ['id', 4360]], 'labels': [5, 3, 8, -1, 6], 'scores': [0.6238884607773032, 1.1989271563468336, 1.6278584181398, 1.9453034106869245, 2.152992189788475]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][34]['acquisition']={'indices': [['id', 27359], ['id', 39482], ['id', 49890], ['id', 1559], ['ood', 9417]], 'labels': [8, 5, 5, 3, -1], 'scores': [0.7414248842053368, 1.4275891562768548, 1.9615332555074834, 2.328490429698375, 2.5678955666941707]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][36]['acquisition']={'indices': [['ood', 35830], ['ood', 11600], ['id', 52462], ['ood', 33596], ['ood', 39314]], 'labels': [-1, -1, 9, -1, -1], 'scores': [0.6138453159168393, 1.1699336255444899, 1.6345302288783214, 1.9758700970330265, 2.2176615885631517]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][37]['acquisition']={'indices': [['id', 15779], ['ood', 29367], ['id', 36008], ['id', 38760], ['id', 47503]], 'labels': [0, -1, 8, 9, 5], 'scores': [0.7155558962698165, 1.3459391617935057, 1.842974304275172, 2.1881197080571786, 2.406491071794642]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][38]['acquisition']={'indices': [['ood', 39314], ['ood', 50276], ['id', 6506], ['ood', 37549], ['ood', 51146]], 'labels': [-1, -1, 8, -1, -1], 'scores': [0.5302246236694614, 1.004580541806415, 1.4308608521198298, 1.7590435745987705, 1.9790050484951207]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][39]['acquisition']={'indices': [['id', 44753], ['ood', 15852], ['id', 26482], ['ood', 52192], ['id', 31946]], 'labels': [5, -1, 6, -1, 5], 'scores': [0.6982862565189136, 1.3035508278818502, 1.802144595176829, 2.169920298602441, 2.3906753422123277]}
store['active_learning_steps'].append({})
