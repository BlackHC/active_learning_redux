...
store['active_learning_steps'][3]['acquisition']={'indices': [['id', 14669], ['id', 30011], ['id', 19643], ['id', 41485], ['ood', 32896]], 'labels': [8, 3, 1, 0, -1], 'scores': [1.046693780057151, 1.9509501839658445, 2.6188241289272502, 3.0222884406581727, 3.243876329251396]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][8]['acquisition']={'indices': [['id', 16376], ['id', 8924], ['id', 35246], ['id', 2231], ['ood', 38890]], 'labels': [1, 2, 8, 8, -1], 'scores': [0.9436737655172016, 1.7648663502252613, 2.4126596945455914, 2.8216593959928566, 3.030536690249888]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][14]['acquisition']={'indices': [['id', 32880], ['id', 19942], ['id', 48102], ['id', 3273], ['ood', 26892]], 'labels': [0, 5, 7, 8, -1], 'scores': [0.7248406435684069, 1.346137704866396, 1.8022698949407516, 2.1313766797868663, 2.3206436368568557]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][18]['acquisition']={'indices': [['id', 42274], ['id', 23262], ['id', 57575], ['ood', 21189], ['id', 46259]], 'labels': [5, 9, 0, -1, 2], 'scores': [0.9229433111332848, 1.702290746065703, 2.262242612284509, 2.5581670763011903, 2.714344717185652]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][22]['acquisition']={'indices': [['id', 59312], ['id', 53854], ['ood', 38890], ['id', 40530], ['id', 47113]], 'labels': [4, 8, -1, 2, 2], 'scores': [0.7621114978316801, 1.409020184201374, 1.9188581143944434, 2.284700757737901, 2.516284927562511]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][28]['acquisition']={'indices': [['id', 27984], ['id', 55438], ['id', 13428], ['id', 44853], ['ood', 24061]], 'labels': [7, 8, 9, 7, -1], 'scores': [0.8211363941118595, 1.5243236202482402, 2.025199725071025, 2.3624441534378704, 2.580775136703785]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][29]['acquisition']={'indices': [['ood', 125], ['id', 48306], ['id', 22994], ['id', 916], ['ood', 18864]], 'labels': [-1, 1, 2, 5, -1], 'scores': [0.7442744072250389, 1.3995180329417924, 1.942828670622493, 2.335523415606229, 2.574075107378124]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][31]['acquisition']={'indices': [['id', 44948], ['ood', 125], ['id', 37347], ['id', 18322], ['id', 13769]], 'labels': [9, -1, 2, 7, 0], 'scores': [0.6750297010225081, 1.207957183883372, 1.6232037365465537, 1.93333879829125, 2.138114674771292]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][32]['acquisition']={'indices': [['id', 38316], ['id', 42337], ['id', 30474], ['id', 13149], ['ood', 3303]], 'labels': [4, 5, 6, 7, -1], 'scores': [0.6962943096408989, 1.3346316155478184, 1.8775066753216265, 2.3032158618954313, 2.5593475434733577]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][34]['acquisition']={'indices': [['id', 20641], ['id', 9677], ['id', 40022], ['id', 30545], ['ood', 39605]], 'labels': [9, 0, 8, 8, -1], 'scores': [0.7310874201346529, 1.3434535310185929, 1.8315988674473758, 2.191957846336466, 2.4025159089773975]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][35]['acquisition']={'indices': [['id', 21066], ['ood', 2198], ['id', 38524], ['id', 42746], ['ood', 43952]], 'labels': [0, -1, 4, 2, -1], 'scores': [0.8294574633706986, 1.493306597876649, 2.058187059392761, 2.472429633822493, 2.743744999666042]}
store['active_learning_steps'].append({})
...
store['active_learning_steps'][37]['acquisition']={'indices': [['id', 46878], ['id', 46441], ['id', 39208], ['id', 46440], ['ood', 32368]], 'labels': [5, 6, 5, 6, -1], 'scores': [0.8168874779545485, 1.4994276962355673, 2.010566212106757, 2.382069080910682, 2.562712076123197]}
store['active_learning_steps'].append({})
