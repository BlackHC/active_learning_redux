...
store['config']={'seed': 437, 'acquisition_size': 10, 'max_training_set': 300, 'num_pool_samples': 20, 'num_eval_samples': 4, 'num_training_samples': 1, 'num_patience_epochs': 3, 'max_training_epochs': 10, 'validation_set_size': 4096, 'initial_set_size': 20, 'samples_per_epoch': 24576, 'repeated_mnist_repetitions': 2, 'add_dataset_noise': True, 'acquisition_function': 'AcquisitionFunction.temperedbaldical', 'save_bald_scores': False, 'temperature': 13}
store['log']={}
...
store['active_learning_steps'][0]['training']['epochs'].append({'accuracy': 0.532958984375, 'crossentropy': 5.646752182394266})
store['active_learning_steps'][0]['training']['epochs'].append({'accuracy': 0.539306640625, 'crossentropy': 5.414437387138605})
store['active_learning_steps'][0]['training']['epochs'].append({'accuracy': 0.533935546875, 'crossentropy': 5.630523022264242})
store['active_learning_steps'][0]['training']['epochs'].append({'accuracy': 0.5205078125, 'crossentropy': 6.108592379838228})
store['active_learning_steps'][0]['training']['epochs'].append({'accuracy': 0.51318359375, 'crossentropy': 6.287071760743856})
store['active_learning_steps'][0]['training']['best_epoch']=2
store['active_learning_steps'][0]['evalution_metrics']={'accuracy': 0.5181, 'crossentropy': 5.434729591369629}
store['active_learning_steps'][0]['pool_training']={}
store['active_learning_steps'][0]['pool_training']['epochs']=[]
store['active_learning_steps'][0]['pool_training']['epochs'].append({'accuracy': 0.56201171875, 'crossentropy': 3.7064241152256727})
store['active_learning_steps'][0]['pool_training']['epochs'].append({'accuracy': 0.556884765625, 'crossentropy': 4.10778621584177})
