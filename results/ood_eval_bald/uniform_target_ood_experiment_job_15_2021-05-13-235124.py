...
store['log']={}
store['exception']='Traceback (most recent call last):\n  File "/auto/users/andsch/github/active_learning_redux/batchbald_redux/uniform_target_ood_experiment.py", line 318, in <module>\n    config.run(store=store)\n  File "/auto/users/andsch/github/active_learning_redux/batchbald_redux/uniform_target_ood_experiment.py", line 175, in run\n    data = self.load_experiment_data()\n  File "/auto/users/andsch/github/active_learning_redux/batchbald_redux/uniform_target_ood_experiment.py", line 89, in load_experiment_data\n    FastMNIST("data", train=True, download=True, device=self.device), "FastMNIST (train)"\n  File "/auto/users/andsch/github/active_learning_redux/batchbald_redux/fast_mnist.py", line 28, in __init__\n    self.data, self.targets = self.data.to(device), self.targets.to(device)\n  File "/scratch-ssd/andsch/tmp/conda_envs/job-5938/lib/python3.8/site-packages/torch/cuda/__init__.py", line 170, in _lazy_init\n    torch._C._cuda_init()\nRuntimeError: CUDA driver initialization failed, you might not have a CUDA gpu.\n'
