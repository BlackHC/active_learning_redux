...
__all__ = ['RestoringEarlyStopping', 'PatienceWithSnapshot', 'ReduceLROnPlateauWithSchedule', 'lr_step_after_epoch',
...
class ReduceLROnPlateauWithSchedule(object):
    ...
    def step(self, metrics, epoch=None):
        ...
        if self.is_better(current, self.best):
            ...
            if self.verbose:
                print(f"Epoch {epoch}: {current} worse than {self.best}, patience: {self.num_bad_epochs}/{self.patience}!")
