...
__all__ = ['compute_conditional_entropy', 'compute_entropy', 'JointEntropy', 'ExactJointEntropy', 'batch_multi_choices',
           'gather_expand', 'SampledJointEntropy', 'DynamicJointEntropy']
