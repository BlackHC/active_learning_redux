...
__all__ = ['CandidateBatchComputer', 'Random', 'PoolScorerCandidateBatchComputer', 'BALD', 'TemperedBALD',
           'SoftmaxBALD', 'RandomBALD', 'ThompsonBALD', 'BatchBALD', 'CoreSetPoolScorerCandidateBatchComputer',
           'CoreSetBALD', 'TemperedCoreSetBALD', 'BatchCoreSetBALD', 'EvalCandidateBatchComputer',
           'EvaluationPoolScorerCandidateBatchComputer', 'EvalBALD', 'TemperedEvalBALD', 'BatchEvalBALD', 'EIG',
           'BatchEIG', 'TemperedEIG', 'CoreSetEvaluationPoolScorerCandidateBatchComputer', 'CoreSetPIGBALD',
           'TemperedCoreSetPIGBALD', 'CoreSetPIG', 'TemperedCoreSetPIG']
