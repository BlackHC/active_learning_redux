...
__all__ = ['SplitDataset', 'SplitDataLoader', 'train_validation_split', 'get_SVHN', 'get_CIFAR10', 'get_CIFAR100',
           'get_MNIST', 'get_FashionMNIST', 'CIFAR10_NORMALIZE', 'CIFAR10_BATCH_NORMALIZE', 'CIFAR10_BATCH_DENORMALIZE',
           'get_dataset', 'get_dataloaders', 'get_dataloaders_by_name', 'dataset_factories']
...
def train_validation_split(
    *, full_train_dataset, train_labels, validation_set_size, validation_split_random_state
):
...
CIFAR10_BATCH_NORMALIZE = K.Normalize(torch.as_tensor([0.4914, 0.4822, 0.4465]), torch.as_tensor([0.2023, 0.1994, 0.2010]))
CIFAR10_BATCH_DENORMALIZE = K.Denormalize(torch.as_tensor([0.4914, 0.4822, 0.4465]), torch.as_tensor([0.2023, 0.1994, 0.2010]))
...
def get_dataset(
    ...
    *,
    ...
    split_dataset = dataset_factories[name](
        root, validation_set_size, validation_split_random_state, normalize_like_cifar10, device_hint
    )
