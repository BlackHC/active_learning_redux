...
__all__ = ['SplitDataset', 'SplitDataLoader', 'train_validation_split', 'get_SVHN', 'get_CIFAR10', 'get_CINIC10',
           'get_CIFAR100', 'get_MNIST', 'get_FashionMNIST', 'get_EMNIST', 'get_balanced_EMNIST', 'CIFAR10_NORMALIZE',
           'CIFAR10_BATCH_NORMALIZE', 'CIFAR10_BATCH_DENORMALIZE', 'CINIC10_NORMALIZE', 'get_dataset',
           'get_dataloaders', 'get_dataloaders_by_name', 'dataset_factories']
