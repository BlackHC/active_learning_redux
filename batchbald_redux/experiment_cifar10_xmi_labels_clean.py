# AUTOGENERATED! DO NOT EDIT! File to edit: 09g_experiment_cifar10_xmi_labels_clean.ipynb (unless otherwise specified).

__all__ = ['compute_entropy_from_probs', 'ExperimentData', 'ExperimentDataConfig', 'load_experiment_data', 'Experiment',
           'configs']
...
def load_experiment_data(
    *,
    ...
    train_indices = split_dataset.train.dataset.indices
