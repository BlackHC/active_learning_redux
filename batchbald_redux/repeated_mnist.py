# AUTOGENERATED! DO NOT EDIT! File to edit: 05b_repeated_mnist.ipynb (unless otherwise specified).
...
def create_repeated_MNIST_dataset(*, device=None, num_repetitions: int = 3,
                                  add_noise: bool = True):
    # num_classes = 10, input_size = 28

    train_dataset = FastMNIST("data",
                              train=True,
                              download=True,
                              device=device)
