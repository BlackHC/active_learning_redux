store = {}
store['timestamp']=1610212838
store['cmdline']=['/auto/users/andsch/github/active_learning_redux/batchbald_redux/experiment.py', '--id', '158']
...
store['config']={'seed': 2162, 'acquisition_size': 50, 'max_training_set': 300, 'num_pool_samples': 20, 'num_eval_samples': 20, 'num_training_samples': 1, 'num_patience_epochs': 3, 'max_training_epochs': 10, 'validation_set_size': 4096, 'initial_set_size': 20, 'samples_per_epoch': 5056, 'repeated_mnist_repetitions': 2, 'add_dataset_noise': True, 'acquisition_function': 'AcquisitionFunction.thompsonbald', 'save_bald_scores': False, 'temperature': 0.0}
store['log']={}
...
store['active_learning_steps'][0]['training']['epochs'].append({'accuracy': 0.498291015625, 'crossentropy': 6.043912313878536})
store['active_learning_steps'][0]['training']['epochs'].append({'accuracy': 0.4912109375, 'crossentropy': 6.9566714614629745})
store['active_learning_steps'][0]['training']['epochs'].append({'accuracy': 0.5, 'crossentropy': 7.14078364521265})
store['active_learning_steps'][0]['training']['epochs'].append({'accuracy': 0.5, 'crossentropy': 7.251140236854553})
store['active_learning_steps'][0]['training']['best_epoch']=1
store['active_learning_steps'][0]['evalution_metrics']={'accuracy': 0.5086, 'crossentropy': 5.9062192855834965}
