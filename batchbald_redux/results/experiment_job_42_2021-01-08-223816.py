...
store['config']={'seed': 382, 'acquisition_size': 5, 'max_training_set': 300, 'num_pool_samples': 20, 'num_eval_samples': 4, 'num_training_samples': 1, 'num_patience_epochs': 3, 'max_training_epochs': 10, 'validation_set_size': 4096, 'initial_set_size': 20, 'samples_per_epoch': 24576, 'repeated_mnist_repetitions': 2, 'add_dataset_noise': True, 'acquisition_function': 'AcquisitionFunction.temperedbaldical', 'save_bald_scores': False, 'temperature': 13}
store['log']={}
...
store['active_learning_steps'][0]['training']['epochs'].append({'accuracy': 0.42578125, 'crossentropy': 6.747040517628193})
store['active_learning_steps'][0]['training']['epochs'].append({'accuracy': 0.438232421875, 'crossentropy': 5.6136612221598625})
store['active_learning_steps'][0]['training']['epochs'].append({'accuracy': 0.425048828125, 'crossentropy': 5.728951815515757})
store['active_learning_steps'][0]['training']['epochs'].append({'accuracy': 0.43701171875, 'crossentropy': 6.09866039827466})
store['active_learning_steps'][0]['training']['epochs'].append({'accuracy': 0.443115234375, 'crossentropy': 5.967917274683714})
store['active_learning_steps'][0]['training']['best_epoch']=2
store['active_learning_steps'][0]['evalution_metrics']={'accuracy': 0.4568, 'crossentropy': 5.475597528076172}
store['active_learning_steps'][0]['pool_training']={}
store['active_learning_steps'][0]['pool_training']['epochs']=[]
store['active_learning_steps'][0]['pool_training']['epochs'].append({'accuracy': 0.42431640625, 'crossentropy': 4.827526826411486})
store['active_learning_steps'][0]['pool_training']['epochs'].append({'accuracy': 0.434814453125, 'crossentropy': 4.808781947940588})
